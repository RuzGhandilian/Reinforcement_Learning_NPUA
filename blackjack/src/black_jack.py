...
def monte_carlo_es(episodes):
    ...
    def behavior_policy(usable_ace, player_sum, dealer_card):
        ...
        values_ = state_action_values[player_sum, dealer_card, usable_ace, :] / state_action_pair_count[player_sum,
                                                                                dealer_card, usable_ace, :]
...
def monte_carlo_off_policy(episodes):
    ...
    with np.errstate(divide='ignore', invalid='ignore'):
        weighted_estimates = np.where(importance_sampling_ratios != 0,
                                      weighted_returns / importance_sampling_ratios, 0)
